...
const Header: React.FC = () => {
  return (
    <div className="flex z-10 bg-white flex-row shadow-md fixed top-0 w-full  p-4  md:p-6 items-center  justify-center space-x-5 md:space-x-16">
      <Link to={"/"}>
      ...
      <Link to={"/userDetails/createbook"}>
        <div className="hover:bg-slate-400/25 cursor-pointer p-1 rounded-md">
